...
function update()
    ...
    downloadUrlToFile('https://raw.githubusercontent.com/Dmitriy-Makarov/latest/master/upadte?token=AMW4DXFDBDNPIXMAUFWQ54C5PRR3O', fpath, function(id, status, p1, p2) -- um link para seu github onde ha linhas que eu digitei no topico ou em qualquer outro site
